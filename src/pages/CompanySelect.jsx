    ...
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: 'linear-gradient(135deg, #1e1b2e 0%, #262344 50%, #2d2a3e 100%)' }}>
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="mb-2 text-3xl font-bold" style={{ color: '#ffffff !important' }}>RoosterAI</h1>
          <p style={{ color: '#cbd5e1' }}>Selecteer een organisatie om door te gaan</p>
        </div>
                  ...
                  <CardContent className="p-5" style={{ backgroundColor: 'transparent' }}>
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-lg" style={{ color: '#ffffff !important' }}>
                         {company.name}
                        </h3>
